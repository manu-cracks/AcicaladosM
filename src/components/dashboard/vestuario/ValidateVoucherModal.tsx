...
export const ValidateVoucherModal: React.FC<ValidateVoucherModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md overflow-y-auto">
      <div className="bg-[#141414] border border-[#C8A45C]/50 rounded-3xl max-w-lg w-full p-5 sm:p-6 space-y-5 shadow-2xl relative my-6 text-neutral-200 animate-in fade-in zoom-in-95 duration-200">
        {/* Encabezado */}
